          ...
          <Collapse in={expanded} timeout="auto" unmountOnExit>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6} md={4}>
                <TextField fullWidth label="Genêro" />
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <TextField fullWidth label="Produção" />
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <TextField fullWidth label="Ator" />
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <DatePicker
                  datePickerValue={dataLancamento}
                  setDatePickerValue={setDataLancamento}
                  textFieldProps={{
                    fullWidth: true,
